...
export const CODE_TRAVAIL_VIGILANCE: Corpus = {
  ...
  articles: [
    ...
    },
    {
      ...
      // Relevé sur la page le 2026-09-21 ; la loi n'est pas ouverte.
      modifiePar: { texte: "LOI n° 2014-790 du 10 juillet 2014 - art. 6" },
      luLe: "2026-09-02",
      lecture: "agent_verbatim",
      prescrit:
      ...
      toucheLaCible: true,
      motif:
        "[2026-09-21 — RELU À LA SOURCE, ET LA CAUSE CHANGE : ~~événement~~ → `a_trancher`. La surface qui manquait existe (page « Quand ça arrive », ADR-037), et cinq autres obligations événementielles y sont entrées ce jour. Celle-ci n'y entre PAS : elle relève du chapitre « travail dissimulé » de la huitième partie, et l'encoder trancherait à la place de la propriétaire si le module de vigilance est dans le périmètre (décision B1 du dossier du 2026-09-20). CE QUE LA RELECTURE A RELEVÉ : l'article a TROIS alinéas, et le troisième — « Les dispositions du présent article ne s'appliquent pas au particulier qui contracte pour son usage personnel […] » — n'était mentionné nulle part ici ; il est sans effet pour un exploitant professionnel. Le débiteur est « Le maître de l'ouvrage ou le donneur d'ordre » ; les auteurs du signalement comprennent aussi « une association professionnels ». L'injonction s'adresse à SON COCONTRACTANT, même quand l'irrégularité est celle d'un sous-traitant. ET UNE AFFIRMATION DE CE MOTIF N'EST PAS VÉRIFIÉE : la forme « lettre recommandée avec avis de réception, R. 8222-2 » n'est pas dans cet article, et `R. 8222-2` n'a pas été rouvert.] Obligation d'agir pleine et entière, distincte de celle de L. 8222-1 : elle ne naît pas d'un contrat mais d'un SIGNALEMENT ÉCRIT reçu, et elle vaut alors même que toutes les vérifications périodiques ont été faites. ~~Elle est de forme — lettre recommandée avec avis de réception, R. 8222-2 — et~~ Elle est de délai : « aussitôt », « sans délai ». [2026-09-26 : la forme est rayée, non vérifiée — elle n'est pas dans cet article et `R. 8222-2` n'a pas été rouvert.] Elle s'étend au sous-traitant et au subdélégataire, c'est-à-dire à des tiers que l'annuaire des prestataires ne connaît pas. Le référentiel ne la porte pas, et aucune surface du produit ne la mentionne : un dirigeant qui reçoit ce courrier ne trouvera rien dans l'outil qui lui dise quoi faire ni sous quelle forme. C'est le manque le moins visible du chapitre, parce qu'il ne se déclenche jamais tant que rien n'arrive.",
      bloquePar:
        "La décision B1 du dossier du 2026-09-20 : le module de vigilance des prestataires est-il dans le périmètre ? ~~Le déclencheur événementiel, absent du modèle~~ — rayé le 2026-09-26 : la page « Quand ça arrive » (ADR-037) sait dire une obligation événementielle sans la dater, et cette ligne y entrerait telle quelle si B1 la retient.",
    },
    {
      ref: "L. 8222-6",
