...
export const ARRETE_1993_03_19_EPI: Corpus = {
  ...
  etendue: "integral",
  portee:
    "LA BRANCHE UNIQUE CONNUE de l'habilitation de R. 4323-99, et le seul texte du dépôt qui dise quels équipements de protection individuelle se vérifient. Il procède par liste NOMINATIVE et FERMÉE de cinq familles, à douze mois : appareils de protection respiratoire autonomes destinés à l'évacuation ; appareils de protection respiratoire et équipements complets destinés à des interventions accidentelles en milieu hostile ; gilets de sauvetage gonflables ; systèmes de protection individuelle contre les chutes de hauteur ; stocks de cartouches filtrantes antigaz pour appareils de protection respiratoire. TOUT CE QUI N'Y FIGURE PAS ÉCHAPPE À LA VÉRIFICATION PÉRIODIQUE DE R. 4323-99 — casques, gants, chaussures de sécurité, lunettes, protections auditives, masques à usage unique : ceux-là relèvent du maintien en état de conformité de R. 4322-1 et de l'entretien de R. 4323-95, qui sont des états permanents et non des rendez-vous. LA BORNE « DE R. 4323-99 » N'EST PAS UNE PRÉCAUTION DE STYLE, et une première rédaction l'omettait : elle écrivait « n'est soumis à AUCUNE vérification générale périodique », ce qui est faux. L'arrêté du 7 mars 2013, en vigueur, pris sur R. 4412-111 et R. 4412-113 — donc hors de cette habilitation —, impose aux appareils de protection respiratoire utilisés lors d'opérations exposant à l'amiante un contrôle avant chaque utilisation, une décontamination après, et une vérification « a minima tous les douze mois ». Le champ en est étroit (R. 4412-94), il ne concerne pas les secteurs servis, et il n'est pas dépouillé : ce qui compte ici est que la phrase du dépôt ne prétende plus à une portée qu'elle n'a pas. Une affirmation absolue est fausse dès qu'un seul texte la dément. Quatre articles, tous en vigueur depuis le 1er décembre 1993 ; texte en vigueur au 2026-09-04, jamais modifié depuis sa publication (dernière mise à jour des données affichée par Légifrance : 1993-12-01). Aucune version future programmée. Intégral : les quatre articles du sommaire Légifrance sont ici, y compris la clause d'exécution. L'article 1er est `retenu` DEPUIS L'APRÈS-MIDI DU MÊME JOUR. Il était `obligation_manquante` à la lecture, bloqué par une décision de modèle : `CategorieEquipement.EPI` est une FAMILLE et non un régime, et la viser entière aurait réclamé ce rendez-vous à qui a déclaré des gants. La décision a été prise — trois catégories, `EPI_ANTICHUTE`, `EPI_RESPIRATOIRE`, `EPI_GILET_SAUVETAGE` —, et `epi-verification-generale-periodique` porte les douze mois sur les CINQ familles, pas sur la seule qui touche les secteurs servis : restreindre l'assiette à une clientèle supposée aurait été interpréter le texte.",
  articles: [
    {
