  ...
  articles: [
    {
      ...
      motif:
        "UNE VÉRIFICATION GÉNÉRALE PÉRIODIQUE À DOUZE MOIS QUE LE RÉFÉRENTIEL NE PORTE POUR AUCUN ÉQUIPEMENT DE PROTECTION INDIVIDUELLE. Les cinq familles ne se tranchent pas de la même façon, et il faut les tenir séparées plutôt que de les traiter en bloc.\n\nLA SEULE QUI TOUCHE LES SECTEURS CIBLES EST LA QUATRIÈME : « systèmes de protection individuelle contre les chutes de hauteur ». C'est le harnais antichute avec sa longe et son absorbeur, et il n'est pas rare hors industrie — accès à une toiture-terrasse, à une mezzanine de réserve, à une trémie de monte-charge. Le dépôt le connaît déjà par l'autre bout : `code-travail-travail-en-hauteur` porte la NOTICE des points d'ancrage de R. 4323-61, et son entrée dit expressément que l'obligation qu'elle fonde « n'est PAS une obligation relative aux EPI […] L'obligation porte sur la notice de l'employeur, pas sur la vérification périodique du harnais. » La vérification du harnais, c'est ici, et elle manque.\n\nLES QUATRE AUTRES SONT HORS CIBLE PAR LE FAIT, SANS QU'AUCUN MOT DU TEXTE NE LES ÉCARTE. Appareils de protection respiratoire autonomes d'évacuation et équipements complets pour interventions en milieu hostile : matériel d'équipe d'intervention industrielle ou de sécurité civile. Gilets de sauvetage gonflables : activité nautique. Stocks de cartouches filtrantes antigaz : ils accompagnent les précédents. Ni un restaurant, ni un commerce de détail, ni un bureau n'en détient couramment — mais un établissement du produit qui en détiendrait serait dans le champ, et le référentiel ne le lui dirait pas.\n\nCE QUI EST ÉCARTÉ, ET IL FAUT LE DIRE AUSSI FORT : tout le reste des équipements de protection individuelle. Le texte est une liste FERMÉE. Casque, gants, chaussures de sécurité, lunettes, écran facial, protections auditives, masque à usage unique, vêtement de travail — aucun n'est soumis à vérification générale périodique par ce texte ni par aucun autre que ce lot ait trouvé. Le guide commercial que `etablissements/parametrage.ts` mentionnait depuis le 2026-09-01 (« a déjà fait croire à une périodicité annuelle générale des EPI qui n'existe pas ») avait donc le BON CHIFFRE et la MAUVAISE ASSIETTE — exactement le mode d'erreur relevé sur le guide de la signalisation le 2026-09-02.",
      bloquePar:
        "UNE DÉCISION DE MODÈLE, ET ELLE N'APPARTIENT PAS À UN LOT DE DÉPOUILLEMENT — c'est pourquoi cette entrée reste `obligation_manquante` au lieu d'être encodée le jour de sa lecture.\n\nLE DÉFAUT À ÉVITER EST NOMMÉ ET DÉJÀ MESURÉ AILLEURS. `CategorieEquipement.EPI` est une FAMILLE, pas un régime : elle couvre, d'après son propre libellé de formulaire, « harnais antichute et sa longe, casque, gants, chaussures de sécurité, protections auditives, masque ». Poser une obligation sur cette catégorie ferait réclamer une vérification annuelle par personne qualifiée — criticité élevée, coût de tiers réel — au commerçant qui a déclaré une boîte de gants. C'est le défaut exact que `COMPACTEUR_PRESSE_DECHETS_MOTORISE` a été nommée pour éviter : « une catégorie de ce nom attirerait le pétrin, le laminoir, la trancheuse — que l'arrêté ne vise pas —, et leur réclamerait tous les trois mois une vérification de criticité 5 ».\n\nCE QUE LE TEXTE PERMET DE DIRE, ET C'EST TOUT CE QU'IL PERMET. La ligne de partage se lit dans la liste ci-dessus, verbatim, et elle est nette : cinq familles nommées d'un côté, tout le reste de l'autre. Elle ne se lit PAS dans une propriété technique de l'équipement — l'arrêté n'écrit ni « antichute », ni « respiratoire » comme critère, il écrit des NOMS D'OBJETS ; il n'y a donc rien à dériver d'un attribut comme « hauteur de chute » ou « type de protection ». Trois voies restent ouvertes et une seule doit être choisie, en connaissance de ce qui suit : scinder la catégorie pour que ce qui se vérifie se déclare à part de ce qui ne se vérifie pas ; ajouter une `ConditionApplication` portée par une propriété d'équipement, ce que l'arrêté ne fonde pas puisqu'il ne nomme aucune propriété ; ou ne rien porter et le déclarer. Le choix est écrit en toutes lettres dans `docs/journal-des-verifications.md` à la date du 2026-09-04, avec ce qui plaide pour et contre chacune.",
    },
    {
