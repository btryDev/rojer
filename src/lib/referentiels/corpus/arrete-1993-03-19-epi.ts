  ...
  articles: [
    {
      ...
      reserve:
        "DEUX EXIGENCES DE L'ARTICLE QUE L'OBLIGATION NE PORTE PAS, et ce sont les seules — le reste est encodé.\n\n1. « EN SERVICE OU EN STOCK ». L'article soumet au même régime l'équipement rangé et l'équipement utilisé : un harnais neuf au placard depuis treize mois ne peut pas être mis en service sans vérification. Le produit ne distingue pas le stock du service — un équipement déclaré est un équipement, et il porte son échéance. L'écart SUR-APPLIQUE, et il est visible par celui qui le subit : il voit une échéance sur un équipement qu'il n'utilise pas. L'inverse aurait dispensé du contrôle un équipement dont la défaillance se découvre le jour où l'on en a besoin.\n\n2. LA PÉREMPTION, portée par le 3° de l'article 2 : les équipements arrivés à la date de péremption fixée par le fabricant doivent être éliminés. Aucun champ du modèle ne stocke cette date, et l'inventer serait pire que l'absence. C'est une donnée qui manque, pas une règle oubliée.",
