...
export const CODE_TRAVAIL_EPI: Corpus = {
  ...
  etendue: "integral",
  portee:
    "Chemin : partie réglementaire, quatrième partie (santé et sécurité au travail), livre III (équipements de travail et moyens de protection), titre II (utilisation des équipements de travail et des moyens de protection), chapitre III (mesures d'organisation et conditions d'utilisation), section 9 « Dispositions particulières pour l'utilisation des équipements de protection individuelle ». Seize articles, trois sous-sections : caractéristiques et conditions d'utilisation (R. 4323-91 à -98), vérifications périodiques (R. 4323-99 à -103), information et formation des travailleurs (R. 4323-104 à -106). S'applique à tout employeur, sans condition d'effectif, de régime ERP ni d'activité. AUCUN de ces seize articles ne pose de périodicité : la seule de la section est renvoyée par R. 4323-99 à des arrêtés, et l'arrêté lu ne soumet que cinq familles d'équipements nommément désignées (corpus `arrete-1993-03-19-epi`), toutes les cinq portées depuis le 2026-09-04 par `epi-verification-generale-periodique`. Quatorze articles sont en vigueur depuis le 1er mai 2008 (décret n° 2008-244 du 7 mars 2008) ; R. 4323-97 depuis le 2 juin 2025 (décret n° 2025-482 du 27 mai 2025, dit « chaleur ») et R. 4323-105 depuis le 1er janvier 2018 (décret n° 2017-1819 du 29 décembre 2017, comité social et économique). Aucune version future programmée. UN SEUL article reste `obligation_manquante` : R. 4323-106, la formation au port, dont le texte ne chiffre aucun rythme (« renouvelée aussi souvent que nécessaire »). R. 4323-105 — la consigne d'utilisation, seul écrit de la section — est `retenu` depuis l'après-midi du 2026-09-04, portée par `epi-etablissement-consigne-utilisation`. Cette portée disait encore le contraire au soir du même jour : le corpus n'avait pas été relu après l'encodage, et une relecture l'a relevé.",
  articles: [
    ...
    },
    {
      ...
      reserve:
        "L'ARTICLE PRESCRIT AUSSI UNE PIÈCE, ET ELLE N'EST PAS PORTÉE ICI. Outre la qualification du vérificateur — qui fonde `personne_qualifiee` sur `epi-verification-generale-periodique` —, il exige que la LISTE des personnes qualifiées « soit tenue à la disposition de l'inspection du travail ». Cette liste EST portée par le référentiel, sous `prevention-etablissement-liste-personnes-qualifiees`, mais fondée sur R. 4323-23 et R. 4323-24 — les équipements de TRAVAIL. R. 4323-100 en est le jumeau pour les EPI, et aucune référence ne le nomme.\n\nCe n'est pas une obligation manquante : la pièce attendue est la même, et une seconde ligne « tenir une liste » ferait doublon à l'écran. C'est une citation manquante, qui se solde en ajoutant R. 4323-100 aux `referencesLegales` de cette obligation-là. Le dépouillement du matin l'avait diagnostiquée et renvoyée hors périmètre ; le périmètre a changé l'après-midi même, et la correction n'a pas suivi.",
    },
    {
      ref: "R. 4323-101",
      ...
      statut: "sans_objet",
      motif:
        "Traçabilité sans rythme propre : la consignation naît de la vérification et n'existe pas sans elle. La vérification est encodée depuis le 2026-09-04 (`epi-verification-generale-periodique`), et c'est elle qui porte la date ; la consignation n'a pas de rendez-vous à elle. L'article est cité au dirigeant par la liste des documents obligatoires (`verifications-epi`), dont le `ouLeTrouver` a été repris le même soir : il annonçait encore qu'aucune échéance d'EPI n'était engendrée. Le registre lui-même est porté ailleurs, par L. 4711-5.",
    },
    {
      ref: "R. 4323-102",
      intitule:
      ...
      statut: "sans_objet",
      motif:
        "Modalité d'archivage, sans périodicité propre — elle suit la vérification comme R. 4323-101, encodée depuis le 2026-09-04.",
    },
    {
      ref: "R. 4323-103",
