...
export const obligationsAeration: Obligation[] = [
  ...
  // ---------------------------------------------------------------------------
  {
    ...
    description:
      "L'employeur maintient en bon état de fonctionnement, et fait contrôler régulièrement, l'ensemble des installations d'aération et d'assainissement de ses locaux de travail — ce que le texte désigne par « les installations mentionnées au présent chapitre ». Le rythme est fixé par l'arrêté du 8 octobre 1987 : au minimum une fois par an en local à pollution non spécifique — le cas des bureaux, commerces et salles de restaurant. L'obligation porte sur l'ensemble, pas sur tel ou tel appareil : elle est due même si aucune installation n'est déclarée dans l'outil.",
    referencesLegales: [
      {
        source: "CODE_TRAVAIL",
        reference: "R. 4222-20",
  ...
  },
  {
    ...
    porteur: "etablissement",
    notesInternes:
      "LA SEULE OBLIGATION MANQUANTE QUE RIEN NE BLOQUAIT (registre de dette du 2026-09-20 : soixante-six manquantes classées par cause, une seule `libre`). Le corpus la portait en `obligation_manquante` depuis le 2026-09-01, quand le lot A a retiré `aeration-travail-mise-en-service` de cet article — qui n'impose ni vérification ni contrôle, seulement la rédaction d'une consigne.\n\nMÊME CHAMP QUE `aeration-controle-installations-r4222-20` : les deux articles vivent dans la même section 5 « Contrôle et maintenance des installations » du chapitre « Aération, assainissement » (fil d'Ariane relevé le 2026-09-20). D'où le même porteur et la même typologie. Pas d'`equipementsEnContexte` : la consigne est un écrit de l'établissement, elle ne se rattache à aucun appareil.\n\n`pieceAttendue` EST NOMMÉE, à la différence des deux lignes « chaleur intense » du même jour : ici le texte exige un ÉCRIT — « indique dans une consigne d'utilisation » —, et c'est cet écrit que R. 4224-17 agrège au dossier de maintenance des lieux de travail.\n\nCE QUE L'OUTIL NE TRACE PAS : l'avis du médecin du travail et du CSE. Condition de bonne exécution, comme l'avis du médecin de R. 4224-16 ; aucun champ ne la porte. Le CSE n'existe qu'à partir de onze salariés : en dessous, seul l'avis du médecin du travail est recueillable, ce que le texte ne dit pas et que le produit ne tranche pas.\n\nCriticité 2 : un écrit d'organisation, du rang de `prevention-etablissement-liste-personnes-qualifiees`. Aucune périodicité au texte : `autre`, état permanent.",
  },
  // ---------------------------------------------------------------------------
  ...
  // ---------------------------------------------------------------------------
  {
    ...
    domaine: "aeration",
    libelle:
      "Vérification annuelle des installations techniques de chauffage-ventilation (ERP des 4 premières catégories)",
    description:
      "Les installations de chauffage, de ventilation et de conditionnement d'air des ERP sont vérifiées annuellement par un technicien compétent, pour s'assurer du bon état des matériels et du respect des prescriptions. Cette vérification relève du livre II du règlement de sécurité, dont l'article PE 1 écrit, pour les établissements de 5ᵉ catégorie : « Les dispositions du livre II ne sont pas applicables sauf celles relevant d'articles expressément mentionnés dans la suite du présent livre. »",
    referencesLegales: [
      {
        source: "ARRETE",
        reference:
