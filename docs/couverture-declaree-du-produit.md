...
Les 24 articles ci-dessous sont ceux que le dépouillement a lus, qui imposent
...
2026-09-03, puis 20 → 24 le 2026-09-20** (arrêté du 1er février 2010,
légionelles : quatre entrées, avec une adresse visible — voir sa famille au § 3). Neuf articles du chapitre III
...
## 3. Les 24 articles lus et non portés
...
### Légionelles, eau chaude sanitaire collective des ERP — 4 entrées (2026-09-20)
...
**Ces quatre-là ont une adresse visible, et elle existait avant eux** : la page
du module « Carnet sanitaire », qui outille le « fichier sanitaire » de
l'article 3 et cite désormais le champ des articles 1er et 2 au lieu d'affirmer
« obligatoire pour tout établissement avec ECS ». Le cliquet `MUETS` ne bouge
...
- **La page des éléments exclus** (`etablissements/[id]/perimetre`), ouverte le
  ...
  **Elle ne donne PAS d'adresse aux 24 articles `non_couvert`**, et un test le
