...
- **Corrections de la relecture du N4, le 2026-09-13** — deux sessions
  ...
  6. **Reste ouvert, écrit** : une ligne rouverte par `aDesarchiver` garde sa
     ...
     **Au déploiement** : les prédicats agissent tout de suite sur les lignes
     ...
     de `dateDocument` ~~à la levée comprise~~ ~~à la veille de la levée~~ ou
     après, **sans borne de levée** (dernière relecture, 2026-09-15) — vigueur
     et écran lisent le même prédicat en jour civil (`prescriptionEnVigueur`,
     `estPrescriptionLevee`) —, sur les lignes qu'il vise
     ...
     dernier rapport fait sous l'acte**~~ (relecture d'intégration) — cette
     garde empêchait d'enregistrer la vraie date de la pièce (un PV de levée du
     jour d'un rapport, un organisme passé après la levée au titre de son
     contrat) et affirmait un « rythme » que rien ne prouvait. **Retirée le même
     jour** : la levée garde la date de la pièce, et c'est la suppression qui
     protège, en comptant sans borne de levée — antidatée « au 01/06/2024 »
     après deux rapports de 2025, la prescription reste insupprimable. ~~Le compte ne dépend plus de la régénération.~~ Il ne dépend plus
